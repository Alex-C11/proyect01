<div class="row sales row sales layout-top-spacing border-gray-200 dark:border-gray-700">
    <div class="py-6 ">
                    ...
                    <table class="w-full divide-y divide-gray-200 table-auto">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">{{ $associate->Stand->row }}-{{ $associate->Stand->column }}</td>
